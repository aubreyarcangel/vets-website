        ...
        <div className={bodyClasses}>
          ...
          {!volatileData && (
            <a
              ...
              aria-label={`${itemNameAction || 'Edit'} ${itemName || title}`}
            >
              {itemNameAction || 'Edit'} {itemName || title}
            </a>
          )}
          {!volatileData && (
            <div
              className={
                selectedAddress === this.props.name
                  ? BLUE_BACKGROUND
                  : WHITE_BACKGROUND
              }
            >
              <input
                ...
                checked={selectedAddress === this.props.name}
                onChange={e => this.handleSelect(e.target.id)}
                aria-label={`Send my order to this address`}
              />
          ...
          {/* {!volatileData &&
            this.props.name === 'temporaryAddress' && (
              <div
                className={
                  !selectedAddress ? BLUE_BACKGROUND : WHITE_BACKGROUND
                }
              >
                <input
                  type="radio"
...
const mapStateToProps = state => ({
  selectedAddress: state.form?.data?.selectedAddress || '',
});
